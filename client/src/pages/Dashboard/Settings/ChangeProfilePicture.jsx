...
import { updateProfilePicture } from "../../../features/profile/profileAPI"
      ...
      <div className='flex gap-x-4 items-center ' >
        ...
        <div className='space-y-2'>
          ...
          <div className='flex gap-x-3' >
            ...
            <button onClick={handleClick} disabled={loading} className={` bg-richblack-600 text-richblack-5 lg:py-2 py-1 lg:px-5 px-2 border border-richblack-400 rounded-md  tracking-wider 
